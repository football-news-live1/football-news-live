...
export default function Footer() {
  ...
  return (
    <footer className="footer-gradient footer-lazy border-t border-white/10 mt-12" role="contentinfo">
      <div className="max-w-7xl mx-auto px-4 py-10">
        ...
        <div className="border-t border-white/10 mt-8 pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-gray-500 text-xs text-center md:text-left">
            © {year} Football News Live. All rights reserved. Data provided by API-Football.
          </p>
          <p className="text-gray-600 text-xs text-center italic">
            Football News Live is not affiliated with any football organization. For entertainment purposes only.
          </p>
        </div>
      </div>
    </footer>
